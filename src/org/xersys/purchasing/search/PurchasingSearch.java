...
public class PurchasingSearch implements iSearch{
    ...
    public PurchasingSearch(XNautilus foApp, Object foValue){
        _app = foApp;
        _message = "";
    ...
    private void initFilterList(){
        ...
        if (null != _search_type)switch (_search_type) {
            case searchPO:                
                ...
                _fields.add("sReferNox"); _fields_descript.add("PO Number");
                _fields.add("sTermName"); _fields_descript.add("Term");
                
                _filter_list.add("IFNULL(b.sClientNm, '')"); _filter_description.add("Supplier");
                _filter_list.add("a.sReferNox"); _filter_description.add("PO Number");
                _filter_list.add("a.cTranStat"); _filter_description.add("Status");
                break;
            case searchPOReceiving:                
                _fields.add("sTransNox"); _fields_descript.add("Trans. No.");
                _fields.add("sClientNm"); _fields_descript.add("Supplier");
                _fields.add("sReferNox"); _fields_descript.add("DR No.");
                _fields.add("sTermName"); _fields_descript.add("Term");
